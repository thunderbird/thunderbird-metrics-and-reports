...
Cause clusters over-represented in a specific Thunderbird version, ranked by **lift** (× more than release-adoption alone explains). Click an ID to read it.


| Lift | When | Version × Cause | Qs | Trend | Example questions |
|---:|:--|:--|--:|:--|:--|
