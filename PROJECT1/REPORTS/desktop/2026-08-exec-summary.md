...
_Executive summary · **2026-08** · 388 questions · regenerated 2026-08-15 05:38 UTC · no AI (regex + traditional stats)_

## 🚨 August 2026: 5 spikes to investigate

**5 version×cause** (release regressions) and **0 cause-level** (provider / protocol / AV) spike(s) cleared threshold. Detail is collapsed below.
...
|:--|--:|--:|--:|
| **version×cause** (release regressions) | 4 | 0 | 1 |
| **cause-level** (provider · protocol · AV) | 0 | 0 | 0 |

- **Volume:** 388 questions (`▅▄▇▇▆▇██▅▇▅▆▇▇▂` by day), 118 (30%) carry a cause tag
- **Answered (non-creator):** 294/388 (76%) · median first answer 2.2h
...
| monthly | **512.0×** | 2026-08 | tb_version_major | 153 | 256 [1596031](https://support.mozilla.org/questions/1596031 "why is thunderbird not working") [1596048](https://support.mozilla.org/questions/1596048 "thunderbrd version 153.0.1 64bit: some registered adress get filtered as spam th") | 0.5 |
...
| weekly | **38.4×** | 2026-08-10 | tb_version_major | 153 | 96 [1597513](https://support.mozilla.org/questions/1597513 "Migrate emails to another provider") [1597551](https://support.mozilla.org/questions/1597551 "Thunderbird POP stopped retrieving email from one mail box, No error message") | 2.5 |
