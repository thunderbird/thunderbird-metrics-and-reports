...
Executive summary for 2026-09. It covers 365 Thunderbird Desktop support questions. The tool wrote this page on 2026-09-11 05:32 UTC. No AI read the questions. The tool uses regular expressions and standard statistics only.
...
## September 2026: 11 spikes to investigate

8 of them tie to a Thunderbird version. 3 of them are cause-level. Every row is in the collapsed blocks below.

September 2026 is still in progress. The counts will grow.

In short: Virgin Media and Printing. Both are in [What stands out](#what-stands-out), with 4 smaller clusters.

| Detector | daily | weekly | monthly |
|:--|--:|--:|--:|
| version×cause (a release caused the problem) | 2 | 4 | 2 |
| cause-level (mail host, protocol, antivirus, feature) | 0 | 3 | 0 |

Three more numbers for context:

- Volume: 365 questions. 178 of them (49%) carry a cause tag. The count per day was `▆█▇▆▄▄█▆▆▅▂`, one block per day from September 1 to September 11.
- Answers: 260 of the 365 questions (71%) got an answer from somebody other than the person who asked. The middle time to the first answer was 3.4 hours.
- Release-adoption version spikes: 16. Users move to a new release, so the bare counts rise. These are not incidents.
...
1. Virgin Media ([`m:virginmedia`](explorer.html#grain=monthly&cause=m:virginmedia&period=2026-09), 1 spike): 5 questions in September, under the monthly bar. It peaked in the week of 2026-09-07 at 25.7 times expected, on Thunderbird 155.
2. Printing ([`feat:printing`](explorer.html#grain=monthly&cause=feat:printing&period=2026-09), 4 spikes): 8 questions in September, under the monthly bar. It peaked on 2026-09-01 at 17.3 times expected, on Thunderbird 154.
3. Filters ([`feat:filters`](explorer.html#grain=monthly&cause=feat:filters&period=2026-09), 2 spikes): 13 questions in September, under the monthly bar. It peaked in the week of 2026-09-07 at 4.5 times expected, on Thunderbird 155.
4. POP ([`proto:pop`](explorer.html#grain=monthly&cause=proto:pop&period=2026-09), 1 spike): 19 questions in September, under the monthly bar. It peaked on 2026-09-07 at 4.0 times expected, on Thunderbird 155.
5. Attachments ([`feat:attachments`](explorer.html#grain=monthly&cause=feat:attachments&period=2026-09), 2 spikes): 16 questions in September, under the monthly bar. It peaked in the week of 2026-08-31 at 3.8 times expected, on Thunderbird 154.

1 more cluster fired: [`m:spectrum`](explorer.html#grain=monthly&cause=m:spectrum&period=2026-09). It is in the detail below.

In 2 clusters, fewer than 60% of the questions got an answer: `v155 × m:virginmedia` in the week of 2026-09-07 (25% answered), `v155 × feat:filters` in the week of 2026-09-07 (50% answered).
...
<details markdown="1">
<summary>Release-adoption version and operating-system spikes (not incidents), 16 rows</summary>
...
| daily | new | 2026-09-10 | tb_version_major | 155 | 13 [1603189](https://support.mozilla.org/questions/1603189 "Thunderbird not responding, reinstall/safe mode not helping") [1603227](https://support.mozilla.org/questions/1603227 "I can't install Thunderbird on my new laptop") | 0.0 |
...
| monthly | new | 2026-09 | tb_version_major | 155 | 141 [1601641](https://support.mozilla.org/questions/1601641 "no recibos los correos") [1601684](https://support.mozilla.org/questions/1601684 "Problemi filtro  ricerca mail") | 0.0 |
| monthly | 24.4× | 2026-09 | tb_version_major | 153 | 61 [1601441](https://support.mozilla.org/questions/1601441 "Emails not downloading") [1601614](https://support.mozilla.org/questions/1601614 "How do I change my user name in the login in for Thunderbird?") | 2.5 |
...
| weekly | new | 2026-09-07 | tb_version_major | 155 | 64 [1602611](https://support.mozilla.org/questions/1602611 "yahoo not populating email after password change") [1602653](https://support.mozilla.org/questions/1602653 "skupiny kontaktů Google") | 0.0 |
