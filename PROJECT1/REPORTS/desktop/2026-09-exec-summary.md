...
Executive summary for 2026-09. It covers 775 Thunderbird Desktop support questions. The tool wrote this page on 2026-09-24 05:34 UTC. No AI read the questions. The tool uses regular expressions and standard statistics only.
...
## September 2026: 24 spikes to investigate

16 of them tie to a Thunderbird version. 8 of them are cause-level. Every row is in the collapsed blocks below.
...
|:--|--:|--:|--:|
| version×cause (a release caused the problem) | 5 | 8 | 3 |
| cause-level (mail host, protocol, antivirus, feature) | 2 | 5 | 1 |

Three more numbers for context:

- Volume: 775 questions. 359 of them (46%) carry a cause tag. The count per day was `▅▇▇▅▄▄▇▆▆▅▆▃▄▅▆▆▅▄▃▃▅▆█▂`, one block per day from September 1 to September 24.
- Answers: 555 of the 775 questions (72%) got an answer from somebody other than the person who asked. The middle time to the first answer was 3.5 hours.
- Release-adoption version spikes: 32. Users move to a new release, so the bare counts rise. These are not incidents.
...
1. Alice it ([`m:alice_it`](explorer.html#grain=monthly&cause=m:alice_it&period=2026-09), 8 spikes): 15 questions in September, 15.0 times the baseline of 1.0. It peaked on 2026-09-23 with 9 questions, where earlier periods had none.
2. Printing ([`feat:printing`](explorer.html#grain=monthly&cause=feat:printing&period=2026-09), 4 spikes): 8 questions in September, under the monthly bar. It peaked on 2026-09-01 at 18.7 times expected, on Thunderbird 154.
3. Virgin Media ([`m:virginmedia`](explorer.html#grain=monthly&cause=m:virginmedia&period=2026-09), 1 spike): 6 questions in September, under the monthly bar. It peaked in the week of 2026-09-07 at 17.1 times expected, on Thunderbird 155.
4. Microsoft mail ([`m:microsoftemail`](explorer.html#grain=monthly&cause=m:microsoftemail&period=2026-09), 2 spikes): 47 questions in September, under the monthly bar. It peaked on 2026-09-16 at 8.0 times its baseline.
5. Yahoo Mail ([`m:yahooemail`](explorer.html#grain=monthly&cause=m:yahooemail&period=2026-09), 3 spikes): 45 questions in September, under the monthly bar. It peaked on 2026-09-16 at 7.2 times expected, on Thunderbird 153.
...
<details markdown="1">
<summary>Near misses (within about 25% of the threshold), 7 rows</summary>
...
<details markdown="1">
<summary>Release-adoption version and operating-system spikes (not incidents), 32 rows</summary>
...
| monthly | new | 2026-09 | tb_version_major | 155 | 232 [1601641](https://support.mozilla.org/questions/1601641 "no recibos los correos") [1601684](https://support.mozilla.org/questions/1601684 "Problemi filtro  ricerca mail") | 0.0 |
| monthly | new | 2026-09 | tb_version_major | 156 | 111 [1603530](https://support.mozilla.org/questions/1603530 "Strange things happening with TB 156.0b3 (32-bit)  and Yahoo") [1603857](https://support.mozilla.org/questions/1603857 "beta 3 is stopped getting mails") | 0.0 |
| monthly | 58.0× | 2026-09 | tb_version_major | 153 | 145 [1601441](https://support.mozilla.org/questions/1601441 "Emails not downloading") [1601614](https://support.mozilla.org/questions/1601614 "How do I change my user name in the login in for Thunderbird?") | 2.5 |
...
| weekly | new | 2026-09-21 | tb_version_major | 156 | 53 [1606312](https://support.mozilla.org/questions/1606312 "Thunderbird intermittently fails to download certain POP emails that are visible") [1606364](https://support.mozilla.org/questions/1606364 "Ogni volta che ravvio il pc Thunderbird perde le password.") | 0.0 |
