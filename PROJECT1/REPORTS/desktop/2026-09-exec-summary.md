...
Executive summary for 2026-09. It covers 676 Thunderbird Desktop support questions. The tool wrote this page on 2026-09-22 05:34 UTC. No AI read the questions. The tool uses regular expressions and standard statistics only.
...
- Volume: 676 questions. 317 of them (47%) carry a cause tag. The count per day was `▆█▇▆▄▄█▆▆▆▆▃▅▆▇▇▆▄▃▄▅▁`, one block per day from September 1 to September 22.
- Answers: 493 of the 676 questions (73%) got an answer from somebody other than the person who asked. The middle time to the first answer was 3.8 hours.
- Release-adoption version spikes: 30. Users move to a new release, so the bare counts rise. These are not incidents.
...
1. Printing ([`feat:printing`](explorer.html#grain=monthly&cause=feat:printing&period=2026-09), 4 spikes): 8 questions in September, under the monthly bar. It peaked on 2026-09-01 at 18.4 times expected, on Thunderbird 154.
2. Virgin Media ([`m:virginmedia`](explorer.html#grain=monthly&cause=m:virginmedia&period=2026-09), 1 spike): 6 questions in September, under the monthly bar. It peaked in the week of 2026-09-07 at 16.8 times expected, on Thunderbird 155.
3. Microsoft mail ([`m:microsoftemail`](explorer.html#grain=monthly&cause=m:microsoftemail&period=2026-09), 2 spikes): 42 questions in September, under the monthly bar. It peaked on 2026-09-16 at 8.0 times its baseline.
...
5. Attachments ([`feat:attachments`](explorer.html#grain=monthly&cause=feat:attachments&period=2026-09), 2 spikes): 20 questions in September, under the monthly bar. It peaked in the week of 2026-08-31 at 3.8 times expected, on Thunderbird 154.
...
In 3 clusters, fewer than 60% of the questions got an answer: `v155 × m:virginmedia` in the week of 2026-09-07 (25% answered), `v153 × m:yahooemail` in the week of 2026-09-07 (50% answered), `v153 × proto:oauth` in the week of 2026-09-14 (25% answered).
...
<details markdown="1">
<summary>Release-adoption version and operating-system spikes (not incidents), 30 rows</summary>
...
| monthly | new | 2026-09 | tb_version_major | 155 | 229 [1601641](https://support.mozilla.org/questions/1601641 "no recibos los correos") [1601684](https://support.mozilla.org/questions/1601684 "Problemi filtro  ricerca mail") | 0.0 |
| monthly | new | 2026-09 | tb_version_major | 156 | 71 [1603530](https://support.mozilla.org/questions/1603530 "Strange things happening with TB 156.0b3 (32-bit)  and Yahoo") [1603857](https://support.mozilla.org/questions/1603857 "beta 3 is stopped getting mails") | 0.0 |
| monthly | 50.8× | 2026-09 | tb_version_major | 153 | 127 [1601441](https://support.mozilla.org/questions/1601441 "Emails not downloading") [1601614](https://support.mozilla.org/questions/1601614 "How do I change my user name in the login in for Thunderbird?") | 2.5 |
...
| weekly | new | 2026-09-21 | tb_version_major | 156 | 13 [1606312](https://support.mozilla.org/questions/1606312 "Thunderbird intermittently fails to download certain POP emails that are visible") [1606364](https://support.mozilla.org/questions/1606364 "Ogni volta che ravvio il pc Thunderbird perde le password.") | 0.0 |
