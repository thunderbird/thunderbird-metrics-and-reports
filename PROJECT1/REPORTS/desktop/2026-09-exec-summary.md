...
Executive summary for 2026-09. It covers 397 Thunderbird Desktop support questions. The tool wrote this page on 2026-09-12 05:32 UTC. No AI read the questions. The tool uses regular expressions and standard statistics only.
...
- Volume: 397 questions. 194 of them (49%) carry a cause tag. The count per day was `▆█▇▆▄▄█▆▆▆▆▁`, one block per day from September 1 to September 12.
- Answers: 285 of the 397 questions (72%) got an answer from somebody other than the person who asked. The middle time to the first answer was 3.4 hours.
- Release-adoption version spikes: 17. Users move to a new release, so the bare counts rise. These are not incidents.
...
1. Virgin Media ([`m:virginmedia`](explorer.html#grain=monthly&cause=m:virginmedia&period=2026-09), 1 spike): 5 questions in September, under the monthly bar. It peaked in the week of 2026-09-07 at 20.5 times expected, on Thunderbird 155.
2. Printing ([`feat:printing`](explorer.html#grain=monthly&cause=feat:printing&period=2026-09), 4 spikes): 8 questions in September, under the monthly bar. It peaked on 2026-09-01 at 17.4 times expected, on Thunderbird 154.
3. POP ([`proto:pop`](explorer.html#grain=monthly&cause=proto:pop&period=2026-09), 1 spike): 22 questions in September, under the monthly bar. It peaked on 2026-09-07 at 4.0 times expected, on Thunderbird 155.
...
In 4 clusters, fewer than 60% of the questions got an answer: `v155 × m:virginmedia` in the week of 2026-09-07 (25% answered), `v155 × feat:filters` in the week of 2026-09-07 (50% answered), `v153 × m:yahooemail` in the week of 2026-09-07 (17% answered), `feat:filters` in the week of 2026-09-07 (55% answered).
...
<details markdown="1">
<summary>Release-adoption version and operating-system spikes (not incidents), 17 rows</summary>
...
| monthly | new | 2026-09 | tb_version_major | 155 | 158 [1601641](https://support.mozilla.org/questions/1601641 "no recibos los correos") [1601684](https://support.mozilla.org/questions/1601684 "Problemi filtro  ricerca mail") | 0.0 |
| monthly | 25.6× | 2026-09 | tb_version_major | 153 | 64 [1601441](https://support.mozilla.org/questions/1601441 "Emails not downloading") [1601614](https://support.mozilla.org/questions/1601614 "How do I change my user name in the login in for Thunderbird?") | 2.5 |
...
| weekly | new | 2026-09-07 | tb_version_major | 155 | 81 [1602611](https://support.mozilla.org/questions/1602611 "yahoo not populating email after password change") [1602653](https://support.mozilla.org/questions/1602653 "skupiny kontaktů Google") | 0.0 |
