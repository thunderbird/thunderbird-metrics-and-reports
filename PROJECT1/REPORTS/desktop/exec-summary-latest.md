...
Executive summary for 2026-08. It covers 941 Thunderbird Desktop support questions. The tool wrote this page on 2026-09-12 05:31 UTC. No AI read the questions. The tool uses regular expressions and standard statistics only.
...
## August 2026: 25 spikes to investigate

15 of them tie to a Thunderbird version. 10 of them are cause-level. Every row is in the collapsed blocks below.
...
|:--|--:|--:|--:|
| version×cause (a release caused the problem) | 7 | 7 | 1 |
...
1. Printing ([`feat:printing`](explorer.html#grain=monthly&cause=feat:printing&period=2026-08), 11 spikes): 36 questions in August, 8.0 times the baseline of 4.5. It peaked on 2026-08-20 at 24.7 times expected, on Thunderbird 154.
2. Spectrum ([`m:spectrum`](explorer.html#grain=monthly&cause=m:spectrum&period=2026-08), 6 spikes): 34 questions in August, 3.2 times the baseline of 10.5. It peaked in the week of 2026-08-17 at 11.0 times its baseline.
...
<details markdown="1">
<summary>Near misses (within about 25% of the threshold), 13 rows</summary>
