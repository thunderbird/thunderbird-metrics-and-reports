...
Executive summary for 2026-09. It covers 31 Thunderbird Android support questions. The tool wrote this page on 2026-09-24 07:17 UTC. No AI read the questions. The tool uses regular expressions and standard statistics only.
...
September 2026 holds 31 questions, about 1 a day. The detectors need 8 questions of one kind in a day, 6 in a week or 8 in a month before they call a spike. At this volume most real clusters cannot clear those floors, so read a zero as "nothing large enough to fire", not as "nothing happened".

Only 16% of the September 2026 questions carry a Thunderbird version. The version×cause detector therefore cannot fire. Read its zero as missing data, not as a clean result.

Three more numbers for context:

- Volume: 31 questions. 15 of them (48%) carry a cause tag. The count per day was `▆▁█▅▁▅▁▁▃▁▃▁▃▅▃█▅▃▃▃▅▃▅`, one block per day from September 1 to September 23.
- Answers: 26 of the 31 questions (84%) got an answer from somebody other than the person who asked. The middle time to the first answer was 3.5 hours.
