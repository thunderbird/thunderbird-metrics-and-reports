...
Executive summary for 2026-09. It covers 23 Thunderbird Android support questions. The tool wrote this page on 2026-09-18 07:16 UTC. No AI read the questions. The tool uses regular expressions and standard statistics only.
...
September 2026 holds 23 questions, about 1 a day. The detectors need 8 questions of one kind in a day, 6 in a week or 8 in a month before they call a spike. At this volume most real clusters cannot clear those floors, so read a zero as "nothing large enough to fire", not as "nothing happened".

Only 17% of the September 2026 questions carry a Thunderbird version. The version×cause detector therefore cannot fire. Read its zero as missing data, not as a clean result.

Three more numbers for context:

- Volume: 23 questions. 12 of them (52%) carry a cause tag. The count per day was `▆▁█▅▁▅▁▁▃▁▃▁▃▅▃█▅`, one block per day from September 1 to September 17.
- Answers: 18 of the 23 questions (78%) got an answer from somebody other than the person who asked. The middle time to the first answer was 2.5 hours.
